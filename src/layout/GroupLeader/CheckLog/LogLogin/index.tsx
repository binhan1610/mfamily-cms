...
import { converPhone, convertTime, reConverPhone, useLogLogin } from '../../service';
...
function LogLogin() {
    ...
    },
    {
      ...
      render: (_: number, record: any) => (
        <>
          ...
          {record?.state === 'LOGOUT' && <>Đăng xuất</>}
          {record?.state === 'LOGIN' && <>Đăng nhập</>}
        </>
      ),
    },
    {
  ...
  return (
    <div>
      <ActionHead
        title={`Lịch sử đăng nhập - Trưởng nhóm #${
